...
public class Level_11_DynamicPage_Rest_Parametter extends AbstractTest {
...
//		registerPage = new RegisterPageObject(driver);
	...
	public void TC_03_New_Customer() {
		newCustomerPage = PageGeneratoManager.getNewCustomerPage(driver);
...
//		New customer -> Deposit
		depositPage = PageGeneratoManager.getDeposittPage(driver);
...
////		fund -> logout
	...
	public void TC_04_Logout() {
		...
		loginPage= PageGeneratoManager.getLoginPage(driver);
		loginPage.openMenuPagesByName(driver, "Log out");
